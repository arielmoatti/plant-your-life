...
('Areca Palm','Dypsis lutescens','https://www.houseplantsexpert.com/assets/images/areca_palm_1.jpg','Foliage',TRUE,TRUE,1,2,TRUE,'16-24','240',2
),
...
('Jade (Money) Plant','Crassula Ovata','https://www.houseplantsexpert.com/image-files/jade-plant.jpg','Succulents',FALSE,FALSE,1,3,FALSE,'15-24','90',1
),
...
('Moth orchid','Phalaenopsis','https://www.houseplantsexpert.com/image-files/moth_orchid_white.jpg','Flowering',TRUE,FALSE,1,2,TRUE,'16-24','90',2
),
('Baby Rubber Plant','Peperomia obtusifolia','https://www.houseplantsexpert.com/assets/images/american_baby_rubber_plant.jpg','Succulents',TRUE,FALSE,2,2,TRUE,'18-24','25-30',2
),
('African Violet','Saintpaulia','https://www.houseplantsexpert.com/assets/images/av-blue-1.jpg','Flowering',TRUE,FALSE,2,3,TRUE,'16-24','7-40',2
),
('Flamingo Flower','Anthurium scherzerianum','https://www.houseplantsexpert.com/image-files/baby_boomer1.jpg','Flowering',FALSE,FALSE,3,3,FALSE,'18-24','30-45',3
),
...
('Mother In Law''s Tongue','Sansevieria trifasciata','https://www.houseplantsexpert.com/image-files/mother-in-laws-tongue-plant.jpg','Flowering',FALSE,TRUE,1,3,TRUE,'15-24','70',1
),
('Dragon Tree','Dracaena marginata','https://www.houseplantsexpert.com/image-files/Dracaena-marginata.jpg','Foliage',FALSE,TRUE,2,2,FALSE,'18-24','240',1
),
...
('Barberton Daisy','Gebera Jamesonii ','https://www.houseplantsexpert.com/assets/images/red_gerbera_daisy_flower_1.jpg','Flowering',TRUE,TRUE,3,3,FALSE,'13-24','65',2
),
...
('Tomato Totem','Solanum Lycopersicum','https://www.flowerpower.com.au/media/catalog/product/cache/e4d64343b1bc593f1c5348fe05efa4a6/image/3253026c75/tomato-totem.jpg','Edible',TRUE,FALSE,3,3,FALSE,'10-25','100',2
),
