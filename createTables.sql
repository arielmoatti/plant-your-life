...
('Peace Lily','Spathiphyllum Wallisii','https://www.houseplantsexpert.com/image-files/p_lily.jpg','Flowering',FALSE,TRUE,3,3,TRUE,'44190','45-60',3,'The peace lily plant is very popular and easy enough for most growers to care for and maintain, which is one of the reason''s it has become so favored. The simplistic look of the glossy leaves and the fantastic white lily that sits above the foliage provides a minimalistic room with an added touch of simplicity.'
),
...
('Flamingo Flower','Anthurium scherzerianum','https://www.houseplantsexpert.com/image-files/baby_boomer1.jpg','Flowering',FALSE,FALSE,3,3,FALSE,'18-24','30-45',3,'The flamingo flower plant is a species from the Anthuirum genus that displays great looking waxed effect flowers which bloom with an orange curly spadix. The Anthurium scherzerianum from the genus is suitable for a room within a home because of the acceptable height it grows up to, and of course the attractive spathe it displays for decor purposes.'
),
...
('Barberton Daisy','Gebera Jamesonii ','https://www.houseplantsexpert.com/assets/images/red_gerbera_daisy_flower_1.jpg','Flowering',TRUE,FALSE,3,2,FALSE,'13-24','65',2,'Barberton daisy is the common name for the Gebera Jamesonii, also known as the Transvaal or Gerbera daisy. The large range of striking flower colors has enabled this flowering pot plant to become a popular house plant choice for a number of years.'
),
...
('Christmas Cheer','Sedum rubrotinctum','https://www.houseplantsexpert.com/assets/images/sedum_rubrotinctum.jpg','Succulents',TRUE,FALSE,1,3,TRUE,'18-24','30',2,'This species from the Sedum genus is easily confused with the Jelly beans plant. The main difference between these two plants is the Christmas cheer leaves will turn red when given enough sunlight.'
),
('Housetree Leek','Aeonium Arboreum','https://www.houseplantsexpert.com/assets/images/aeonium_arboreum_atropurpureum.jpg','Succulents',TRUE,FALSE,1,1,FALSE,'21-30','90',2,'The Housetree leek plant is a sub-tropical succulent species that''s primarily grown outdoors. However, being native to the sub-tropics enables the Aeonium arboreum to grow well indoors, and the colder months outdoors in temperate regions are not suitable growing conditions.'
),
('Peruvian Apple Cactus ','Cereus peruvianus','https://www.houseplantsexpert.com/image-files/peruvian-apple-cactus-close-up.jpg','Succulents',TRUE,FALSE,1,2,TRUE,'16-24','120',2,'The Peruvian apple cactus (also known as columnar, column, hedge cactus and others) has the scientific name of Cereus peruvianus or C.repandus. This Cereus (Genus) cacti can produce white flowers within summer - that open up at night, once it matures and a prominent ribbed column stem, with brown colored spines, is displayed.'
),
('Basil','Basilikum','https://bilder.t-online.de/b/85/78/77/44/id_85787744/610/tid_da/basilikumpflanze-basilikum-fuehlt-sich-an-warmen-sonnigen-plaetzen-besonders-wohl-braucht-aber-viel-wasser-.jpg','Edible',TRUE,FALSE,3,3,FALSE,'18-24','30',2,'Basil is great'
);
